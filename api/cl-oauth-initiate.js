...
module.exports = async (req, res) => {
  ...
  const PROVIDERS = {
    ...
    xero: {
      ...
      scopes: 'openid profile email accounting.invoices.read accounting.contacts.read accounting.settings.read accounting.reports.profitandloss.read accounting.reports.balancesheet.read projects.read offline_access',
