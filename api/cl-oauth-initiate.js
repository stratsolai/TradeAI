...
export default async function handler(req, res) {
  ...
  const PROVIDERS = {
    ...
    xero: {
      ...
      scopes: 'openid profile email accounting.invoices.read accounting.contacts.read accounting.settings.read accounting.transactions.read accounting.reports.profitandloss.read accounting.reports.balancesheet.read projects.read offline_access',
