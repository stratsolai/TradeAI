  ...
  _render: function() {
    ...
    container.innerHTML = [
      ...
      "<div class=\"upload-primary-actions\">",
        "<button id=\"cl-photo-btn\" class=\"upload-zone\">",
          "<span class=\"upload-zone-icon\">📷</span>",
          "<span class=\"upload-zone-label\">Add Photo</span>",
          "<span class=\"upload-zone-hint\">Tap to add a photo from your device</span>",
        "</button>",
        "<button class=\"upload-zone\" id=\"cl-doc-drop\">",
          "<span class=\"upload-zone-icon\">📄</span>",
          "<span class=\"upload-zone-label\">Upload Document or File</span>",
          "<span class=\"upload-zone-hint\">Drag and drop or tap to browse</span>",
        "</button>",
        "<button class=\"upload-zone\" id=\"cl-manual-btn\">",
          "<span class=\"upload-zone-icon\">✏️</span>",
          "<span class=\"upload-zone-label\">Add Manual Item</span>",
          "<span class=\"upload-zone-hint\">Add content directly to your library</span>",
        "</button>",
      "</div>",
