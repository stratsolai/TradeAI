window.DASH_DATA = (function() {
  ...
  var TOOLS = [
    { id: 'social',         icon: '\ud83d\udcf1', name: 'Marketing & Social Media Manager', desc: 'AI builds your posts, graphics and marketing content \u2014 auto-posts to Facebook and Instagram', price: '$79',  status: 'built',   url: '/social',         settingsUrl: '/social-settings.html',            priceId: 'price_1TEQg8HnoVvjo5gxkxUaFrok', benefit: 'Works great with Content Library' },
    ...
    { id: 'tender',         icon: '\ud83d\udccb', name: 'Tender Response Generator',        desc: 'AI reads the tender brief and generates a full professional response \u2014 ready to submit',       price: '$99',  status: 'pending', url: '/panel?tool=tender',          settingsUrl: null, priceId: 'price_1TEQjVHnoVvjo5gxfyLbHE3M', benefit: '' },
