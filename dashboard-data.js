window.DASH_DATA = (function() {
  ...
  var TOOLS = [
    { id: 'social',         icon: '\ud83d\udcf1', name: 'Marketing & Social Media Manager', desc: 'AI builds your posts, graphics and marketing content \u2014 auto-posts to Facebook and Instagram', price: '$89',  status: 'built',   url: '/social',         settingsUrl: '/social-settings.html',            priceId: 'price_1TEQg8HnoVvjo5gxkxUaFrok', benefit: 'Works great with Content Library' },
    { id: 'email',          icon: '\ud83d\udce7', name: 'AI Email Assistant',               desc: 'AI reads your Gmail and Outlook \u2014 summarised on one smart dashboard',                          price: '$59',  status: 'built',   url: '/email',          settingsUrl: '/email-assistant-settings.html',   priceId: 'price_1TQLhHHnoVvjo5gxnwUQQYwM', benefit: 'Feeds into BI insights' },
    { id: 'chatbot',        icon: '\ud83d\udcac', name: 'AI Website Chatbot',               desc: 'AI chatbot for your website \u2014 answers customers, qualifies leads, books jobs \u2014 24/7',     price: '$79',  status: 'built',   url: '/chatbot',        settingsUrl: '/chatbot-settings.html',           priceId: 'price_1TRlgkHnoVvjo5gxXR6NMrkR', benefit: 'Uses your Content Library' },
    { id: 'news-digest',    icon: '\ud83d\udcf0', name: 'Industry News Digest',             desc: 'Industry news, regulation changes, supplier updates \u2014 AI-summarised on one dashboard',          price: '$59',  status: 'built',   url: '/news',           settingsUrl: '/news-digest-settings.html',       priceId: 'price_1TQLehHnoVvjo5gxjv8cH40m', benefit: 'Feeds into BI insights' },
    ...
    { id: 'strategic-plan', icon: '\ud83d\uddfa\ufe0f', name: 'Strategic Plan & Operations', desc: 'Create your roadmap in minutes from a simple AI-guided interview',                                  price: '$89',  status: 'built',   url: '/strategy',       settingsUrl: null,                               priceId: 'price_1TB7DDHnoVvjo5gxgLzZbego', benefit: 'Works great with BI Dashboard' },
    ...
    { id: 'tender',         icon: '\ud83d\udccb', name: 'Tender Response Generator',        desc: 'AI reads the tender brief and generates a full professional response \u2014 ready to submit',       price: '$89',  status: 'pending', url: '/panel?tool=tender',          settingsUrl: null, priceId: 'price_1TEQjVHnoVvjo5gxfyLbHE3M', benefit: '' },
    { id: 'quote-enhancer', icon: '\ud83d\udcb0', name: 'Quote Enhancer',                   desc: 'Turn your prices into a professional branded quote with AI-written scope of works',                 price: '$79',  status: 'pending', url: '/panel?tool=quote-enhancer', settingsUrl: null, priceId: 'price_1TB8QZHnoVvjo5gxwL0GKduI', benefit: '' },
    { id: 'swms',           icon: '\ud83e\uddba', name: 'SWMS & Safety Docs',               desc: 'AI generates compliant Safe Work Method Statements tailored to your trade and job',                 price: '$79',  status: 'pending', url: '/panel?tool=swms',            settingsUrl: null, priceId: 'price_1TB8RNHnoVvjo5gxPb5wxUuF', benefit: '' },
    { id: 'customer-updates',icon:'\ud83d\udcf2', name: 'Customer Progress Updates',        desc: 'Keep customers informed automatically with AI-generated job progress updates',                      price: '$69',  status: 'pending', url: '/panel?tool=customer-updates', settingsUrl: null, priceId: 'price_1TB8S6HnoVvjo5gxVYoEezlN', benefit: '' },
    { id: 'handover-docs',  icon: '\ud83d\udcc1', name: 'Handover Documentation',           desc: 'Professional handover packs generated from your job data \u2014 warranties, compliance, sign-off',  price: '$79',  status: 'pending', url: '/panel?tool=handover-docs',  settingsUrl: null, priceId: 'price_1TB8ShHnoVvjo5gxrGBAMHZL', benefit: '' },
    { id: 'review-booster', icon: '\u2b50',       name: 'Review & Referral Booster',        desc: 'AI identifies the right moment to ask for reviews and referrals \u2014 and writes the message',     price: '$69',  status: 'pending', url: '/panel?tool=review-booster', settingsUrl: null, priceId: 'price_1TB8TFHnoVvjo5gxkF2QMzJa', benefit: '' }
  ];
