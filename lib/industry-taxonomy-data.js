...
export const SERVICES = {
  ...
  'building-and-construction': {
    ...
    'Renovations & Alterations': ['Renovation (Full Home)', 'Renovation (Single Room)', 'Structural Alterations', 'Load-Bearing Wall Removal', 'Kitchen Cabinetry', 'Bathroom Renovation', 'Laundry Renovation', 'Heritage Restoration', 'Plasterboard Installation', 'Tiling (Floor)', 'Waterproofing (Bathrooms)'],
    'Carpentry & Joinery': ['Carpentry (Structural)', 'Carpentry (Finish)', 'Framing', 'Custom Joinery', 'Built-in Wardrobes', 'Staircase Construction'],
    'Roofing & Cladding': ['Roofing (New)', 'Roofing (Repairs)', 'Cladding Installation', 'Insulation Installation', 'Weatherboard Repairs', 'Gutter Installation'],
    'Doors & Windows': ['Door Installation', 'Window Installation'],
    'Outdoor Structures': ['Pergola & Gazebo Construction', 'Carport Construction', 'Garage Construction', 'Retaining Walls (Structural)', 'Decking Installation', 'Decking Repairs', 'Fencing Installation', 'Sheds (Installation)', 'Outdoor Kitchens'],
    'Site Works & Foundations': ['Demolition (Full)', 'Demolition (Partial)', 'Underpinning', 'Restumping', 'Construction & Demolition Waste Removal', 'Asbestos Removal (Service)'],
  ...
  'plumbing-and-gas': {
    ...
    'Gas Fitting': ['Gas Fitting (General)', 'Gas Appliance Installation', 'Gas Appliance Repairs', 'Gas Leak Detection', 'Gas Line Installation', 'Gas Compliance Certificate', 'Oven & Stove Repair (Gas)'],
    'Bathroom & Kitchen': ['Bathroom Renovation (Plumbing)', 'Kitchen Plumbing', 'Laundry Plumbing', 'Dishwasher Installation', 'Washing Machine Installation', 'Water Filter Installation', 'Shower Screen Installation'],
  ...
  'electrical-and-solar': {
    ...
    'Lighting & Power': ['Powerpoint Installation', 'Powerpoint Repairs', 'Light Switch Installation', 'Lighting Installation (Standard)', 'Lighting Installation (Feature)', 'Downlight Installation', 'Ceiling Fan Installation', 'Exhaust Fan Installation', 'Outdoor Lighting Installation'],
    ...
    'Solar & EV': ['Solar Panel Installation', 'Solar System Design', 'Solar Battery Installation', 'Solar Inverter Replacement', 'Solar Panel Cleaning', 'Solar System Inspection', 'EV Charger Installation', 'Hot Water System Installation (Solar)'],
    ...
    'Pool & Outdoor Electrical': ['Pool Equipment Installation (Electrical components)'],
  ...
  'hvac-and-refrigeration': {
    ...
    'Heating': ['Gas Heating Installation', 'Gas Heater Service', 'Gas Heater Repairs', 'Hydronic Heating Installation', 'Hydronic Heating Service', 'Hot Water System Installation (Heat Pump)'],
  ...
  'concreting': {
    'Residential Concreting': ['Driveways', 'Paving & Pathways', 'Slabs (House)', 'Slabs (Garage / Shed)', 'Patios', 'Pool Surrounds', 'Retaining Wall Construction (non-structural)'],
  ...
  'bricklaying': {
    'Bricklaying': ['House Bricklaying', 'Commercial Bricklaying', 'Feature Walls', 'Brick Repairs & Repointing', 'Block Laying', 'Retaining Wall Construction (Brick/Block)'],
    'Stonework & Specialty': ['Stonework', 'Stone Cladding', 'Chimney Construction', 'Chimney Repairs', 'Paving & Pathways (Brick/Stone)', 'Rendering (Cement)'],
    'Heritage': ['Heritage Brickwork Restoration', 'Tuckpointing']
  },

  'carpentry': {
    'Structural Carpentry': ['Framing', 'Roof Trusses Installation', 'Wall Frames', 'Floor Joists', 'Plasterboard Installation', 'Timber Floor Installation'],
    ...
    'Joinery': ['Custom Joinery', 'Built-in Wardrobes', 'Bookshelves', 'Cabinetry (On-site)', 'Staircase Construction', 'Kitchen Cabinetry (Installation)'],
    'Decking & Outdoor': ['Decking Installation', 'Decking Repairs', 'Pergola & Gazebo Construction'],
    'Outdoor Structures': ['Carport Construction', 'Outdoor Kitchens', 'Cubby Houses', 'Pergola & Gazebo Construction'],
    'Fencing': ['Fencing Installation (Timber)', 'Fencing Repairs (Timber)'],
  ...
  'tiling-and-flooring': {
    'Tiling': ['Tiling (Floor)', 'Tiling (Wall)', 'Tiling (Bathroom Full)', 'Tiling (Splashback)', 'Tile Repairs', 'Grout Cleaning & Resealing', 'Shower Screen Installation'],
  ...
  'glazing': {
    'Residential Glazing': ['Window Glass Replacement', 'Glass Splashbacks', 'Mirror Installation', 'Shower Screen Installation', 'Glass Balustrades', 'Window Installation (Residential)'],
  ...
  'landscaping-and-garden-services': {
    'Garden Design & Planting': ['Garden Design & Planning', 'Planting & Garden Beds', 'Hedging & Topiary', 'Tree Planting', 'Outdoor Lighting Installation (Garden)', 'Fencing Installation'],
  ...
  'pools-and-fencing': {
    'Pool Construction': ['Pool Construction (Fibreglass)', 'Pool Construction (Concrete)', 'Pool Renovation & Resurfacing'],
    'Pool Servicing': ['Pool Cleaning & Maintenance', 'Pool Equipment Installation'],
    'Fencing': ['Fencing Installation', 'Fencing Repairs', 'Pool Fencing'],
    'Decking & Surrounds': ['Decking Installation', 'Decking Repairs', 'Pergola & Gazebo Construction']
  },

  'fire-and-security-services': {
    'Fire Protection': ['Fire Alarm Installation', 'Fire Alarm Maintenance', 'Sprinkler System Installation', 'Sprinkler System Maintenance', 'Fire Extinguisher Supply & Servicing', 'Emergency Lighting Installation', 'Fire Door Installation & Inspection', 'Smoke Alarm Installation'],
    'Security Systems': ['Security System Installation', 'Security Alarm Monitoring', 'CCTV Installation', 'CCTV Monitoring', 'Access Control Systems', 'Intercom Systems'],
  ...
  'mechanical-and-appliance-repair': {
    ...
    'Installation & Disposal': ['Appliance Installation', 'Old Appliance Removal & Disposal', 'Dishwasher Installation', 'Washing Machine Installation']
  },
  ...
  'cleaning-and-maintenance': {
    ...
    'Handyman Services': ['Handyman (General Repairs)', 'Handyman (Furniture Assembly)', 'Handyman (Picture Hanging)', 'Handyman (Door Repairs)', 'Handyman (Lock Repairs)', 'Test & Tag', 'Plasterboard Repairs', 'Mirror Installation (handyman)'],
    'Property Maintenance': ['Gutter Repairs', 'Fence Repairs', 'Deck Repairs', 'Property Maintenance (Contract)', 'Garden Maintenance', 'Lawn Mowing', 'Rubbish Removal', 'Pool Cleaning & Maintenance', 'Deck Staining & Oiling', 'Fence Painting / Staining']
  },
  ...
  'food-and-beverage-manufacturing': {
    ...
    'Catering Services': ['Catering (On-Site)', 'Catering (Off-Site)']
  },
  ...
  'professional-scientific-and-technical-services': {
    ...
    'Business Advisory & Consulting': ['Business Advisory', 'Business Consulting', 'Strategy Consulting', 'Management Consulting', 'Compliance Training'],
    ...
    'Creative & Communications': ['Graphic Design', 'Branding Services', 'Photography', 'Videography', 'Copywriting', 'Website Development', 'SEO Services', 'Social Media Management']
  },
  ...
  'training-and-education': {
    'Vocational Training': ['Accredited Vocational Training (RTO)', 'Short Courses & Workshops', 'Apprenticeship Training', 'Skills Assessment', 'Apprenticeship & Traineeship Hosting'],
  ...
  'media-and-publishing': {
    ...
    'Content & Production': ['Content Creation', 'Editorial Services', 'Podcast Production', 'Video Production', 'Audio Production', 'Graphic Design', 'Social Media Management'],
  ...
  'telecommunications-and-it-services': {
    ...
    'Digital Services': ['Website Development', 'Website Maintenance', 'App Development', 'SEO Services', 'Digital Marketing', 'Social Media Management', 'Graphic Design'],
  ...
  'waste-and-recycling-services': {
    'Waste Collection': ['Commercial Waste Collection', 'Industrial Waste Collection', 'Residential Skip Bin Hire', 'Construction & Demolition Waste', 'Rubbish Removal (Residential)'],
    'Recycling': ['General Recycling', 'Cardboard & Paper Recycling', 'Metal Recycling', 'E-Waste Recycling', 'Battery & Hazardous Recycling'],
    'Specialty Services': ['Hazardous Waste Disposal', 'Medical Waste Disposal', 'Confidential Document Destruction', 'Liquid Waste Removal', 'Asbestos Removal (Service)']
  }
};
...
export const PRODUCTS = {
  ...
  'building-and-construction': {
    'Structural Materials': ['Timber (Structural)', 'Timber (Finish)', 'Steel Beams', 'Roofing Materials', 'Insulation Batts', 'Cladding Sheets', 'Decking Timber (per m²)', 'Decking Hardware (Joists, Bearers, Fixings)', 'Plasterboard Sheets', 'Guttering (per linear metre)', 'Downpipes', 'Tiles (per m²)', 'Tile Adhesive', 'Grout', 'Waterproofing Membrane'],
    ...
    'Outdoor Structures Materials': ['Fencing Materials (Timber/Colorbond per linear metre)', 'Sheds (Kit / Supply)', 'Outdoor Kitchen Components (Cabinetry, BBQ Surrounds)']
  },

  'plumbing-and-gas': {
    'Hot Water Systems': ['Hot Water Systems (Electric)', 'Hot Water Systems (Gas)', 'Hot Water Systems (Solar)', 'Hot Water Systems (Heat Pump)'],
    'Tapware & Fixtures': ['Toilets', 'Toilet Cisterns', 'Taps (Basin)', 'Taps (Kitchen)', 'Taps (Shower)', 'Showerheads', 'Sinks (Kitchen)', 'Basins (Bathroom)', 'Shower Screens'],
    'Pipes, Tanks & Drainage': ['Gas Appliances', 'Water Filters', 'Rainwater Tanks', 'Guttering (per linear metre)', 'Downpipes']
  },

  'electrical-and-solar': {
    'Solar & EV': ['Solar Panels', 'Solar Inverters', 'Solar Batteries', 'EV Chargers', 'Hot Water Systems (Solar)'],
    'Wiring & Power': ['Switchboards', 'Powerpoints', 'Light Switches', 'Data Cables (per metre)'],
    'Lighting & Fans': ['Downlights', 'Ceiling Fans', 'Outdoor Lighting Fixtures'],
    'Safety & Comms': ['Smoke Alarms', 'Safety Switches', 'TV Antennas', 'CCTV Cameras', 'Security Panels'],
    'Pool Electrical': ['Pool Pumps', 'Pool Lighting']
  },

  'hvac-and-refrigeration': {
    'Cooling & Heating Units': ['Split System Units', 'Ducted System Units', 'Cassette Units', 'Gas Heaters', 'Evaporative Coolers', 'Hot Water Systems (Heat Pump)'],
  ...
  'concreting': {
    'Materials': ['Ready-Mix Concrete (per m³)', 'Reinforcing Steel / Mesh', 'Concrete Sealer', 'Form Boards', 'Retaining Wall Blocks (Concrete)']
  },

  'bricklaying': {
    'Materials': ['Bricks', 'Blocks', 'Mortar', 'Sand & Cement', 'Pavers (per m²)', 'Retaining Wall Blocks (Masonry)', 'Cement Render (per bag)']
  },

  'carpentry': {
    'Materials': ['Timber (Structural)', 'Timber (Finish)', 'Decking Timber (per m²)', 'Composite Decking (per m²)', 'Trim & Mouldings', 'Decking Hardware', 'Kitchen Cabinetry (Flatpack / Custom)', 'Fencing Materials (Timber per linear metre)', 'Plasterboard Sheets', 'Timber Flooring (per m²)', 'Outdoor Kitchen Components', 'Cubby House Kits / Timber Components']
  },
  ...
  'tiling-and-flooring': {
    'Tiles & Flooring': ['Tiles (per m²)', 'Tile Adhesive', 'Grout', 'Timber Flooring (per m²)', 'Laminate Flooring (per m²)', 'Vinyl Flooring (per m²)', 'Carpet (per m²)', 'Underlay (per m²)', 'Shower Screens']
  },

  'glazing': {
    'Glass & Hardware': ['Glass (per m²)', 'Mirrors', 'Shower Screens', 'Splashbacks', 'Window Hardware', 'Windows (Residential)']
  },

  'landscaping-and-garden-services': {
    'Garden Materials': ['Turf (per m²)', 'Mulch (per m³)', 'Soil & Compost (per m³)', 'Plants (per unit)', 'Garden Edging (per linear metre)', 'Outdoor Lighting Fixtures (Garden)', 'Fencing Materials (Timber per linear metre)'],
    'Irrigation': ['Irrigation Controllers', 'Irrigation Sprinklers']
  },

  'pools-and-fencing': {
    'Pool Materials': ['Pool Construction Materials', 'Fibreglass Resin & Components', 'Pool Equipment (Pumps, Filters, Heaters, Chlorinators)', 'Pool Chemicals'],
    'Fencing Materials': ['Fencing Materials (Timber per linear metre)', 'Fencing Materials (Colorbond per linear metre)', 'Pool Fencing (Glass)', 'Pool Fencing (Aluminium)'],
    'Decking Materials': ['Decking Timber (per m²)', 'Decking Hardware (Joists, Bearers, Fixings)']
  },
  ...
  'mechanical-and-appliance-repair': {
    ...
    'Appliances (Supply)': ['Dishwashers (supply for installation)', 'Washing Machines (supply for installation)']
  },

  'cleaning-and-maintenance': {
    'Cleaning Products & Equipment': ['Cleaning Products (commercial supply)', 'Pest Control Products', 'Cleaning Equipment', 'Pool Chemicals (supply)', 'Deck Oil / Stain (per litre)']
  },
  ...
  'food-and-beverage-manufacturing': {
    ...
    'Catering Products': ['Catering Menus / Event Packages']
  },
  ...
  'professional-scientific-and-technical-services': {
    'Documents & Deliverables': ['Reports & Documents', 'Plans & Drawings', 'Creative Assets', 'Compliance Training Materials', 'Website Deliverables / Web Apps', 'SEO Reports & Strategies']
  },
  ...
  'training-and-education': {
    'Materials': ['Training Materials', 'Course Notes & Workbooks', 'Online Course Access', 'Apprenticeship Hosting Agreements']
  },

  'media-and-publishing': {
    'Published Works': ['Books', 'Magazines', 'Digital Subscriptions', 'Audio / Video Content'],
    'Creative Deliverables': ['Graphic Design Deliverables', 'Social Media Content Packages']
  },

  'telecommunications-and-it-services': {
    'Software & Hardware': ['Software Licences', 'Software Subscriptions', 'Hardware (IT)', 'Cloud Storage Plans'],
    'Creative Deliverables': ['Graphic Design Deliverables']
  },
...
export const LICENCES = {
  ...
  'building-and-construction': {
    ...
    'Trade Certifications': ['Waterproofing Licence']
  },
  ...
  'pools-and-fencing': {
    'Pool Construction': ['Pool Builder Licence', 'Pool Safety Inspector Licence', 'Pool Fence Compliance Certificate', 'Backflow Prevention Accreditation'],
    'Site Safety Tickets': ['White Card (Construction Induction)', 'Working at Heights Certificate', 'CPR & First Aid Certificate'],
    'Compliance': ['Public Liability Insurance'],
  ...
  'cleaning-and-maintenance': {
    ...
    'Hazard & Safety': ['Asbestos Assessor Licence', 'Asbestos Awareness Certificate', 'Chemical Handling Certificate', 'Working at Heights Certificate', 'CPR & First Aid Certificate', 'Test & Tag Competency Certificate'],
  ...
  'professional-scientific-and-technical-services': {
    ...
    'Training Qualifications': ['Cert IV in Training & Assessment (TAE40116)']
  },
  ...
  'health-and-community-services': {
    'AHPRA Registration': ['AHPRA Registration (Health Profession)', 'Medicare Provider Number'],
