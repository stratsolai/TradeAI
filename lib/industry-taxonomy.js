...
const METADATA = [
  ...
  { id: 'landscaping-and-garden-services',     displayLabel: 'Landscaping & Garden Services',     srlSubstitution: ['landscaping contractors', 'garden maintenance services'], group: 'construction-and-trades', groupOrder: 12 },
  { id: 'pools-and-fencing',                   displayLabel: 'Pools & Fencing',                   srlSubstitution: ['Outdoor Construction'],                       group: 'construction-and-trades', groupOrder: 13 },
  ...
  { id: 'cleaning-and-maintenance',            displayLabel: 'Cleaning & Maintenance',            srlSubstitution: ['commercial cleaning'],                        group: 'construction-and-trades', groupOrder: 16 },
  ...
  { id: 'equipment-hire',                      displayLabel: 'Equipment Hire',                    srlSubstitution: ['plant hire'],                                 group: 'construction-and-trades', groupOrder: 18 },
  ...
  { id: 'metal-fabrication-and-welding',       displayLabel: 'Metal Fabrication & Welding',       srlSubstitution: ['metal fabrication', 'welding'],               group: 'manufacturing-and-production', groupOrder: 2 },
