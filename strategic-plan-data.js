...
window.SP_SECTIONS = [
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { id: "s4-compliance", apiKey: "complianceStatus", valueType: "string", label: "Compliance Status", type: "chip-single", group: "compliance-chips", required: false, options: [{ value: "all-up-to-date", label: "All Up To Date" },{ value: "mostly", label: "Mostly — Occasional Lapses" },{ value: "behind", label: "Behind — Regularly Catching Up" },{ value: "not-sure", label: "Not Sure" }] }
    ]
  },
