...
window.SP_SECTIONS = [
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { id: "s2-customers", apiKey: "targetCustomers", valueType: "array", label: "Target Customer Types", type: "chip-multi", group: "customer-chips", required: true, options: [{ value: "homeowners", label: "Homeowners" },{ value: "commercial", label: "Commercial" },{ value: "builders", label: "Builders" },{ value: "industrial", label: "Industrial" },{ value: "strata", label: "Strata" },{ value: "retail-hosp", label: "Retail/Hospitality" },{ value: "corporate", label: "Corporate" },{ value: "government", label: "Government" },{ value: "prof-services", label: "Professional Services" },{ value: "nfp", label: "Not-for-Profit" }], allowOther: true },
      { id: "s2-primary-segment", apiKey: "primarySegment", valueType: "string", label: "Primary Customer Segment", labelHint: "(which is your main focus?)", type: "select", required: false, options: [{ value: "", label: "Select..." },{ value: "homeowners", label: "Homeowners" },{ value: "commercial", label: "Commercial" },{ value: "builders", label: "Builders" },{ value: "industrial", label: "Industrial" },{ value: "strata", label: "Strata" },{ value: "retail-hosp", label: "Retail/Hospitality" },{ value: "corporate", label: "Corporate" },{ value: "government", label: "Government" },{ value: "prof-services", label: "Professional Services" },{ value: "nfp", label: "Not-for-Profit" }] },
