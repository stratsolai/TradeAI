...
window.SP_SECTIONS = [
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { id: "s2-most-profitable", apiKey: "mostProfitableService", valueType: "string", label: "Most Profitable Service", labelHint: "(optional)", type: "select", required: false, dynamicFromProfile: "bp_services", emptyMessage: "Add Core Services in your Business Profile to enable this field" },
      // Spec §8.3 — three new Products & Services fields.
      { id: "bp-least-profitable", apiKey: "leastProfitableService", valueType: "string", label: "Least Profitable Service", labelHint: "(optional)", type: "select", required: false, dynamicFromProfile: "bp_services", emptyMessage: "Add Core Services in your Business Profile to enable this field" },
      { id: "bp-services-discontinue", apiKey: "servicesToDiscontinue", valueType: "array", label: "Services to Discontinue", labelHint: "(if any)", type: "chip-multi", group: "discontinue-chips", required: false, allowOther: true, options: [] },
      { id: "bp-warranty-period", apiKey: "warrantyPeriod", valueType: "string", label: "Warranty / Guarantee Period", type: "chip-single", group: "warranty-chips", required: false, options: [{ value: "none", label: "None" },{ value: "30-days", label: "30 Days" },{ value: "90-days", label: "90 Days" },{ value: "1-year", label: "1 Year" },{ value: "2-plus-years", label: "2+ Years" },{ value: "varies", label: "Varies" }] }
    ]
  },
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      // Spec §8.2 — three new Customers & Suppliers fields.
      { id: "bp-cust-satisfaction", apiKey: "customerSatisfactionTracking", valueType: "string", label: "Customer Satisfaction Tracking", type: "chip-single", group: "cust-sat-chips", required: false, options: [{ value: "none", label: "None" },{ value: "informal", label: "Informal" },{ value: "surveys", label: "Surveys" },{ value: "formal-program", label: "Formal Program" }] },
      { id: "bp-payment-offered", apiKey: "paymentTermsOffered", valueType: "string", label: "Payment Terms Offered", helpText: "Standard payment terms you offer customers", type: "chip-single", group: "payment-offered-chips", required: false, options: [{ value: "cod", label: "COD" },{ value: "7-days", label: "7 Days" },{ value: "14-days", label: "14 Days" },{ value: "30-days", label: "30 Days" },{ value: "60-plus-days", label: "60+ Days" }] },
      { id: "bp-supplier-payment", apiKey: "supplierPaymentTerms", valueType: "string", label: "Supplier Payment Terms", helpText: "Standard payment terms your suppliers expect from you", type: "chip-single", group: "supplier-payment-chips", required: false, options: [{ value: "cod", label: "COD" },{ value: "7-days", label: "7 Days" },{ value: "14-days", label: "14 Days" },{ value: "30-days", label: "30 Days" },{ value: "60-plus-days", label: "60+ Days" }] }
    ]
  },
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      // Spec §8.4 — two new Financial Position fields.
      { id: "bp-seasonal-revenue", apiKey: "seasonalRevenuePattern", valueType: "string", label: "Seasonal Revenue Pattern", type: "chip-single", group: "seasonal-chips", required: false, options: [{ value: "consistent", label: "Consistent Year-Round" },{ value: "mild", label: "Mild Seasonality" },{ value: "significant", label: "Significant Peaks & Troughs" },{ value: "highly-seasonal", label: "Highly Seasonal" }] },
      { id: "bp-upcoming-expenses", apiKey: "knownUpcomingExpenses", valueType: "array", label: "Known Upcoming Expenses", labelHint: "(within the next 12 months)", type: "chip-multi", group: "upcoming-exp-chips", required: false, allowOther: true, exclusiveValue: "none-significant", options: [{ value: "vehicle-replacement", label: "Vehicle Replacement" },{ value: "equipment-replacement", label: "Equipment Replacement" },{ value: "lease-renewal", label: "Lease Renewal" },{ value: "insurance-renewal", label: "Insurance Renewal" },{ value: "tax-payment", label: "Tax Payment" },{ value: "loan-repayment", label: "Loan Repayment" },{ value: "staff-payout", label: "Staff Payout" },{ value: "none-significant", label: "None Significant" }] }
    ]
  },
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { id: "s4-key-roles", apiKey: "keyRoles", valueType: "array", label: "Key Roles", type: "chip-multi", group: "roles-chips", required: false, allowOther: true, exclusiveValue: "just-me", options: [{ value: "just-me", label: "Just Me" },{ value: "admin", label: "Admin" },{ value: "office-mgr", label: "Office Manager" },{ value: "accountant", label: "Accountant" },{ value: "biz-dev", label: "Business Development" },{ value: "marketing", label: "Marketing" },{ value: "ops-mgr", label: "Operations Manager" },{ value: "project-mgr", label: "Project Manager" },{ value: "team-leader", label: "Team Leader" },{ value: "technician", label: "Technician / Specialist" },{ value: "customer-service", label: "Customer Service" },{ value: "apprentice", label: "Apprentice / Trainee" }] },
      // Spec §8.5 — two new Operations & Capacity fields.
      { id: "bp-bottleneck", apiKey: "biggestBottleneck", valueType: "string", label: "Biggest Operational Bottleneck", helpText: "Where does work most often slow down?", type: "chip-single", group: "bottleneck-chips", required: false, options: [{ value: "quoting", label: "Quoting" },{ value: "scheduling", label: "Scheduling" },{ value: "delivery", label: "Delivery" },{ value: "invoicing", label: "Invoicing" },{ value: "staff", label: "Staff" },{ value: "equipment", label: "Equipment" },{ value: "none", label: "None" }] },
      { id: "bp-quality-control", apiKey: "qualityControl", valueType: "string", label: "Quality Control", type: "chip-single", group: "quality-chips", required: false, options: [{ value: "none", label: "None" },{ value: "informal", label: "Informal Checks" },{ value: "documented", label: "Documented Process" },{ value: "certified", label: "Certified System" }] }
    ]
  },
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { id: "s5-competitors", apiKey: "topCompetitors", valueType: "array", label: "Top Competitors", labelHint: "(list 3-5 main competitors)", type: "chip-multi", group: "competitors-chips", required: false, allowOther: true, options: [] },
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    subtitle: "Goals, expansion plans, digital transformation, and process improvement. Your answers here drive your Operational Tasks",
    fields: [
      ...
      { id: "s6-goals-12m", apiKey: "goals12Month", valueType: "array", label: "12-Month Goals", type: "chip-multi", group: "goals-12m-chips", required: false, allowOther: true, options: [{ value: "increase-revenue", label: "Increase Revenue" },{ value: "improve-profit", label: "Improve Profitability" },{ value: "reduce-costs", label: "Reduce Costs" },{ value: "grow-customers", label: "Grow Customer Base" },{ value: "improve-retention", label: "Improve Customer Retention" },{ value: "expand-area", label: "Expand Service Area" },{ value: "launch-new", label: "Launch New Products / Services" },{ value: "hire-staff", label: "Hire Staff" },{ value: "improve-systems", label: "Improve Systems / Processes" },{ value: "reduce-workload", label: "Reduce Owner Workload" },{ value: "build-brand", label: "Build Brand Awareness" },{ value: "improve-cash", label: "Improve Cash Flow" },{ value: "exit-succession", label: "Exit / Succession Planning" }] },
      { id: "s6-vision-3yr", apiKey: "vision3Year", valueType: "array", label: "3-Year Vision", type: "chip-multi", group: "vision-3yr-chips", required: false, allowOther: true, options: [{ value: "steady-growth", label: "Steady Growth" },{ value: "significant-expansion", label: "Significant Expansion" },{ value: "market-leader", label: "Market Leader in Area" },{ value: "diversify", label: "Diversify into New Markets" },{ value: "build-to-sell", label: "Build to Sell" },{ value: "lifestyle", label: "Lifestyle Business (Maintain Current)" },{ value: "succession", label: "Succession / Handover" },{ value: "uncertain", label: "Uncertain" }] },
      { id: "s6-growth-strategies", apiKey: "growthStrategies", valueType: "array", label: "Growth Strategies", type: "chip-multi", group: "growth-chips", required: false, allowOther: true, isDecision: true, decisionId: "growth_strategies", options: [{ value: "geo-expansion", label: "Geographic Expansion" },{ value: "new-services", label: "New Products / Services" },{ value: "digital-transform", label: "Digital Transformation" },{ value: "gov-tendering", label: "Government / Council Tendering" },{ value: "partnerships", label: "Strategic Partnerships" },{ value: "acquisition", label: "Acquisition of Competitors" },{ value: "ecommerce", label: "Online / E-Commerce Channel" },{ value: "franchising", label: "Franchising or Licensing" },{ value: "vertical-integration", label: "Vertical Integration" },{ value: "maintenance-contracts", label: "Maintenance Contracts" },{ value: "commercial-expansion", label: "Commercial Work Expansion" },{ value: "commercial-strata", label: "Commercial / Strata Contracts" },{ value: "industry-partnerships", label: "Industry Partnerships" },{ value: "productised", label: "Productised Services" },{ value: "retainer-model", label: "Retainer Model" },{ value: "niche-specialisation", label: "Niche Specialisation" }] },
      { id: "s6-geo-expansion", apiKey: "geoExpansion", valueType: "string", label: "Geographic Expansion", type: "chip-single", group: "geo-chips", required: false, isDecision: true, decisionId: "geo_expansion", options: [{ value: "not_interested", label: "Not a Priority" },{ value: "would-consider", label: "Would Consider — Need Guidance" },{ value: "considering", label: "Considering" },{ value: "pursuing", label: "Actively Pursuing" },{ value: "expanding", label: "Currently Expanding" }] },
      { id: "s6-geo-areas", apiKey: "targetExpansionAreas", valueType: "array", label: "Target Expansion Areas", labelHint: "(if expanding)", type: "chip-multi", group: "geo-areas-chips", required: false, allowOther: true, options: [] },
      { id: "s6-new-services", apiKey: "newServiceLines", valueType: "string", label: "New Products / Services", type: "chip-single", group: "new-svc-chips", required: false, isDecision: true, decisionId: "new_services", options: [{ value: "not_interested", label: "Not a Priority" },{ value: "would-consider", label: "Would Consider — Need Guidance" },{ value: "considering", label: "Considering" },{ value: "pursuing", label: "Actively Pursuing" },{ value: "launched", label: "Recently Launched" }] },
      { id: "s6-planned-services", apiKey: "plannedNewServices", valueType: "array", label: "Planned New Products / Services", labelHint: "(if pursuing)", type: "chip-multi", group: "planned-services-chips", required: false, allowOther: true, options: [] },
      { id: "s6-gov-tendering", apiKey: "govTendering", valueType: "string", label: "Government / Council Tendering", type: "chip-single", group: "gov-chips", required: false, isDecision: true, decisionId: "gov_tendering", options: [{ value: "not_interested", label: "Not a Priority" },{ value: "would-consider", label: "Would Consider — Need Guidance" },{ value: "considering", label: "Considering" },{ value: "occasional", label: "Occasionally Tender" },{ value: "regular", label: "Regular Tender Activity" }] },
      { id: "s6-digital", apiKey: "digitalTransformation", valueType: "string", label: "Digital Transformation", type: "chip-single", group: "digital-chips", required: false, isDecision: true, decisionId: "digital_transform", options: [{ value: "not_interested", label: "Not a Priority" },{ value: "would-consider", label: "Would Consider — Need Guidance" },{ value: "considering", label: "Considering" },{ value: "in_progress", label: "In Progress" },{ value: "advanced", label: "Advanced" }] },
      { id: "s6-digital-focus", apiKey: "digitalFocus", valueType: "array", label: "Digital Transformation Focus", type: "chip-multi", group: "digital-focus-chips", required: false, allowOther: true, options: [{ value: "job-mgmt", label: "Job Management" },{ value: "quoting-invoicing", label: "Quoting / Invoicing" },{ value: "customer-comms", label: "Customer Communication" },{ value: "marketing", label: "Marketing" },{ value: "scheduling-booking", label: "Scheduling / Booking" },{ value: "inventory-mgmt", label: "Inventory Management" },{ value: "document-mgmt", label: "Document Management" },{ value: "ecommerce", label: "E-Commerce / Online Sales" },{ value: "payments-pos", label: "Payments / Point of Sale" },{ value: "staff-mgmt", label: "Staff Management" },{ value: "reporting", label: "Reporting" },{ value: "process-auto", label: "Process Automation" },{ value: "unsure", label: "Unsure — Need Guidance" }] },
      { id: "s6-process", apiKey: "processImprovement", valueType: "string", label: "Process Improvement", type: "chip-single", group: "process-chips", required: false, isDecision: true, decisionId: "process_improve", options: [{ value: "not_priority", label: "Not a Priority" },{ value: "would-consider", label: "Would Consider — Need Guidance" },{ value: "considering", label: "Considering" },{ value: "improving", label: "Actively Improving" },{ value: "continuous", label: "Continuous Improvement" }] },
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { id: "s7-cash-reserve", apiKey: "cashReserve", valueType: "string", label: "Cash Reserve", type: "select", required: false, options: [{ value: "", label: "Select..." },{ value: "none", label: "None" },{ value: "1-month", label: "1 Month" },{ value: "2-3-months", label: "2-3 Months" },{ value: "3-6-months", label: "3-6 Months" },{ value: "6+-months", label: "6+ Months" },{ value: "unsure", label: "Unsure" }] },
      { id: "s7-revenue-reliance", apiKey: "revenueReliance", valueType: "string", label: "Revenue Reliance on Key Customers", helpText: "How dependent is your business on your largest customers?", type: "chip-single", group: "rev-reliance-chips", required: false, options: [{ value: "diversified", label: "Well Diversified — No single customer over 10%" },{ value: "moderately", label: "Moderately Diversified — Largest customer 10-25%" },{ value: "some-reliance", label: "Some Reliance — Largest customer 25-50%" },{ value: "high-reliance", label: "High Reliance — Largest customer over 50%" },{ value: "unsure", label: "Unsure" }] },
      { id: "s7-risks", apiKey: "biggestRisks", valueType: "array", label: "Biggest Business Risks", type: "chip-multi", group: "risk-chips", required: false, allowOther: true, options: [{ value: "seasonal", label: "Seasonal Slowdowns" },{ value: "key-person", label: "Key Person Dependency" },{ value: "late-payments", label: "Late Payments / Bad Debts" },{ value: "material-costs", label: "Material Cost Increases" },{ value: "staff-shortage", label: "Staff Availability" },{ value: "regulatory", label: "Regulatory Changes" },{ value: "equipment", label: "Equipment Breakdown" },{ value: "economic-downturn", label: "Economic Downturn" },{ value: "competition", label: "Competition" },{ value: "tech-disruption", label: "Technology Disruption" },{ value: "reputational", label: "Reputational Risk" }] },
      ...
      { id: "s7-insurance", apiKey: "insuranceCoverage", valueType: "array", label: "Insurance Coverage", type: "chip-multi", group: "insurance-chips", required: false, allowOther: true, options: [{ value: "public-liability", label: "Public Liability" },{ value: "tools-equipment", label: "Tools & Equipment" },{ value: "vehicle-fleet", label: "Vehicle / Fleet" },{ value: "workers-comp", label: "Workers Comp" },{ value: "prof-indemnity", label: "Professional Indemnity" },{ value: "biz-interruption", label: "Business Interruption" },{ value: "cyber", label: "Cyber / Data Breach" },{ value: "product-liability", label: "Product Liability" },{ value: "directors-officers", label: "Directors & Officers" },{ value: "income-protection", label: "Income Protection" },{ value: "key-person", label: "Key Person Insurance" },{ value: "building-property", label: "Building / Property" },{ value: "contents", label: "Contents" },{ value: "marine-transit", label: "Marine / Transit" },{ value: "management-liability", label: "Management Liability" }] },
