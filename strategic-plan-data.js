...
window.SP_SECTIONS = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    fields: [
      ...
      { id: "s1-customers", apiKey: "targetCustomers", valueType: "array", label: "Target Customers", type: "chip-multi", group: "customer-chips", required: false, allowOther: true, options: [{ value: "homeowners", label: "Homeowners" },{ value: "commercial", label: "Commercial" },{ value: "builders-devs", label: "Builders / Developers" },{ value: "industrial", label: "Industrial" },{ value: "strata", label: "Strata / Property Managers" },{ value: "retail-hosp", label: "Retail / Hospitality" },{ value: "corporate", label: "Corporate / Enterprise" },{ value: "government", label: "Government / Council" },{ value: "professional-svcs", label: "Professional Services" },{ value: "nfp", label: "Not-for-Profit / Community" },{ value: "agriculture", label: "Agriculture / Rural" }] },
      { id: "s1-service-area", apiKey: "serviceArea", valueType: "string", label: "Service Area", type: "select-or-text", required: false, placeholder: "Describe your service area", options: [{ value: "", label: "Select..." },{ value: "Local area only", label: "Local area only" },{ value: "Greater metro area", label: "Greater metro area" },{ value: "Within 50km of CBD", label: "Within 50km of CBD" },{ value: "Statewide", label: "Statewide" },{ value: "National", label: "National" }] },
  ...
  // -------------------------------------------------------------------------
  {
    ...
    fields: [
      ...
      { id: "s2-avg-job-value", apiKey: "avgJobValue", valueType: "string", label: "Average Job / Engagement Value", type: "select-or-text", required: false, placeholder: "Enter a specific amount", options: [{ value: "", label: "Select range..." },{ value: "Under $500", label: "Under $500" },{ value: "$500 to $2,000", label: "$500 to $2,000" },{ value: "$2,000 to $10,000", label: "$2,000 to $10,000" },{ value: "Over $10,000", label: "Over $10,000" }] },
      { id: "s2-cost-categories", apiKey: "biggestCosts", valueType: "array", label: "Biggest Cost Categories", type: "chip-multi", group: "cost-chips", required: false, allowOther: true, options: [{ value: "labour", label: "Labour / Wages" },{ value: "materials", label: "Materials" },{ value: "vehicles", label: "Vehicles" },{ value: "insurance", label: "Insurance" },{ value: "rent", label: "Rent / Premises" },{ value: "software", label: "Software & Tools" },{ value: "marketing", label: "Marketing / Advertising" },{ value: "professional-svcs", label: "Professional Services" },{ value: "compliance", label: "Compliance / Licensing" },{ value: "subcontractors", label: "Subcontractors" }] },
  ...
  // -------------------------------------------------------------------------
  {
    ...
    fields: [
      ...
      { id: "s3-marketing-budget", apiKey: "marketingBudget", valueType: "string", label: "Approximate monthly marketing budget", labelHint: "(optional)", type: "select-or-text", required: false, placeholder: "Enter a specific amount", options: [{ value: "", label: "Select range..." },{ value: "None currently", label: "None currently" },{ value: "Under $500", label: "Under $500" },{ value: "$500 to $1,500", label: "$500 to $1,500" },{ value: "$1,500 to $5,000", label: "$1,500 to $5,000" },{ value: "Over $5,000", label: "Over $5,000" }] },
  ...
  // -------------------------------------------------------------------------
  {
    ...
    fields: [
      ...
      { id: "s4-suppliers", apiKey: "suppliers", valueType: "string", label: "Key Suppliers", labelHint: "(main material, service or equipment suppliers)", type: "select-or-text", required: false, placeholder: "Name your key suppliers", options: [{ value: "", label: "Select category..." },{ value: "Trade supplies", label: "Trade supplies" },{ value: "Hardware stores", label: "Hardware stores" },{ value: "Specialist equipment", label: "Specialist equipment" },{ value: "Software providers", label: "Software providers" },{ value: "Wholesale / distribution", label: "Wholesale / distribution" }] },
  ...
  // -------------------------------------------------------------------------
  {
    ...
    fields: [
      { id: "s5-risks", apiKey: "risks", valueType: "array", label: "Biggest Risks to Your Business", labelHint: "(select all that apply)", type: "chip-multi", group: "risk-chips", required: false, allowOther: true, options: [{ value: "seasonal", label: "Seasonal slowdowns" },{ value: "key-person", label: "Key person risk" },{ value: "late-payments", label: "Late payments / bad debts" },{ value: "key-clients", label: "Dependence on a few key clients" },{ value: "material-costs", label: "Material cost increases" },{ value: "staff-shortage", label: "Staff availability / skills shortage" },{ value: "regulatory", label: "Regulatory / compliance changes" },{ value: "equipment", label: "Equipment breakdown" },{ value: "economic-downturn", label: "Economic downturn" },{ value: "competition-large", label: "Competition from larger operators" },{ value: "tech-disruption", label: "Technology disruption" }] },
