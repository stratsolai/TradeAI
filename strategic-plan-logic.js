...
(function() {
  ...
  function renderField(field) {
    ...
    if (field.type === 'text') {
      ...
      input = '<select id="' + field.id + '" class="form-select">' + opts + '</select>';
    } else if (field.type === 'select-or-text') {
      var sOpts = (field.options || []).map(function(o) {
        return '<option value="' + escHtml(o.value) + '">' + escHtml(o.label) + '</option>';
      }).join('');
      sOpts += '<option value="__other__">Other (specify)</option>';
      input = '<select id="' + field.id + '-select" class="form-select sp-select-or-text" data-target="' + field.id + '">' + sOpts + '</select>';
  ...
  function showAddTaskForm(btn) {
    ...
    f += '<div class="sp-add-task-col-sm"><select class="form-select sp-add-task-priority"><option value="High">High</option><option value="Medium" selected>Medium</option><option value="Low">Low</option></select></div>';
    f += '<div class="sp-add-task-col-md"><input type="date" class="sp-input sp-add-task-due"></div>';
    f += '<div class="sp-add-task-col-md"><select class="form-select sp-add-task-owner"><option value="Owner">Owner</option><option value="Admin">Admin</option><option value="Office manager">Office mgr</option><option value="Project manager">Project mgr</option><option value="Other">Other</option></select></div>';
